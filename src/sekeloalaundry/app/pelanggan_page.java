 ...
 * @author yodie
 */
public class pelanggan_page extends javax.swing.JFrame {
...
private void hapus_data() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pelanggan_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pelanggan_page().setVisible(true);
            }
        });
    }
